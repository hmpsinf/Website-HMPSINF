                ...
                */}
                <div className="relative overflow-hidden rounded-[2.5rem] bg-gray-900 dark:bg-gray-950 border border-gray-800 px-6 py-12 sm:px-12 sm:py-16 text-center lg:px-16">
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        ...
                        <div className="absolute top-0 right-0 w-32 h-32 md:w-64 md:h-64 border-l border-b border-white rounded-bl-[2rem] md:rounded-bl-[4rem]"></div>
                        <div className="absolute bottom-0 left-0 w-32 h-32 md:w-64 md:h-64 border-r border-t border-white rounded-tr-[2rem] md:rounded-tr-[4rem]"></div>
